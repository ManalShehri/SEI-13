...
# Lab: DOM Events & jQuery

In this lab, you'll practice with some of the most common DOM events in jQuery:
...
Extra: Instead of just stopping the forms, make it so that clicking the submit buttons adds an embedded youtube video to the page.
...
Extra: Add a "reset" button that clears all the inputs.
...
Extra: In addition to listing the phrase I clicked, can you include a timestamp?
